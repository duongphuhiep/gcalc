object frm_cvunit: Tfrm_cvunit
  ...
  object lst_group: TListView
    ...
    TabOrder = 0
    ViewStyle = vsList
    OnSelectItem = lst_groupSelectItem
  end
  object lst_A: TListView
    ...
    GridLines = True
    Items.Data = {
      3B00000002000000FFFFFFFFFFFFFFFFFFFFFFFF010000000000000002413102
      41320000000001000000FFFFFFFF0000000000000000024132FFFF}
    PopupMenu = pmn_unit
  ...
  object lst_B: TListView
    ...
    GridLines = True
    Items.Data = {
      360000000200000000000000FFFFFFFFFFFFFFFF000000000000000002413100
      000000FFFFFFFFFFFFFFFF0000000000000000024132}
    ShowColumnHeaders = False
    TabOrder = 2
    ViewStyle = vsReport
  end
